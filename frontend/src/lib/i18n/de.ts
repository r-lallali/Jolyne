...
export const de: Messages = {
  ...
  auth: {
    loginCta: "Anmelden",
    loginTitle: "Per E-Mail anmelden",
    loginHint: "Du bekommst einen magischen Link. Kein Passwort.",
    emailPlaceholder: "du@email.com",
    sendLink: "Link senden",
    linkSent: "Link gesendet",
    linkSentHint: "Prüfe dein Postfach (auch Spam) und klicke den Link.",
    invalidEmail: "Ungültige E-Mail",
    verifying: "Wird angemeldet…",
    verified: "Angemeldet.",
    verifyFailed: "Ungültiger oder abgelaufener Link.",
    backToChat: "Zurück zu Jolyne",
    logoutCta: "Abmelden",
