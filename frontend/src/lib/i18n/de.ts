...
export const de: Messages = {
  ...
  auth: {
    ...
    welcomeTitle: "Willkommen bei Jolyne",
    welcomeHint: "Behalte deine Freunde, Streaks und Fortschritte.",
    noAccount: "Noch kein Konto?",
    haveAccount: "Schon ein Konto?",
    termsNotice: "Wenn du fortfährst, akzeptierst du unsere Nutzungsbedingungen.",
    tabLogin: "Anmelden",
    ...
    displayNamePlaceholder: "Spitzname (optional)",
    ...
    passwordCriteria: "Das Passwort erfüllt nicht alle Kriterien",
  ...
  premium: {
    ...
    priceAmount: "10 €",
    pricePeriod: "/ Monat",
    noCommitment: "Ohne Bindung — mit einem Klick kündbar.",
    securePayment: "Sichere Zahlung über Stripe.",
    transparencyTitle: "Wohin dein Geld fließt",
    transparencyHint:
      "Keine Investoren, keine Werbung: dein Abo deckt die echten Kosten des Dienstes.",
    costAI: "KI und Übersetzung",
    costInfra: "Server",
    costFees: "Zahlungsgebühren",
    costDev: "Entwicklung",
    accountTitle: "Abonnement",
    priceMonthly: "10 € / Monat",
    statusFreeTitle: "Kostenloser Plan",
    statusFreeHint:
      "Unbegrenzte Übersetzungen; 10 Partner und 50 KI-Tutor-Nachrichten pro Tag.",
    statusPremiumTitle: "Premium ✨",
    statusPremiumHint: ({ date }) => `Aktiv bis ${date}.`,
    manageCta: "Abonnement verwalten",
    planPremium: "Premium",
    featurePartners: "Partner",
    featureScenarios: "Rollenspiel-Szenarien",
    featureHearts: "Lektions-Herzen",
    allScenarios: "Alle",
    perDay: ({ n }) => `${n} / Tag`,
    featureBot: "KI-Tutor",
