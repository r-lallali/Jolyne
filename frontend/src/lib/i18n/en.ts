...
export const en: Messages = {
  ...
  learn: {
    ...
    yourCourses: "Continue",
    allCourses: "All courses",
    progressLessons: ({ done, total }) => `${done}/${total} lessons`,
    ...
    courseTitles: {
      ...
      travel: "Travel", shopping: "Shopping", "work-school": "Work & School",
      "verbs-basic": "First Verbs", "verbs-mind": "Say & Know", "first-sentences": "First Sentences",
      "question-words": "Question Words", "more-questions": "More Questions", "useful-questions": "Useful Questions",
      meeting: "Meeting Someone", "how-are-you": "How Are You?", wishes: "Wishes",
      transport: "Transport", directions: "Directions", city: "In the City",
      store: "At the Store", clothes: "Clothes", buying: "Buying",
      jobs: "Jobs", school: "School", tech: "Technology",
    },
    streak: "Streak",
    ...
    listen: "Listen",
    tapTranslateHint: "Tap a word to translate it",
    quit: "Quit",
    ...
    practice: "Review my notebook",
    practiceNote: "Free practice — no hearts, no XP",
    practiceDone: "Review complete!",
  ...
  auth: {
    ...
    welcomeTitle: "Welcome to Jolyne",
    welcomeHint: "Keep your friends, streaks and progress.",
    noAccount: "No account yet?",
    haveAccount: "Already have an account?",
    termsNotice: "By continuing, you agree to our terms of use.",
    tabLogin: "Sign in",
    tabSignup: "Sign up",
    ...
    passwordCriteria: "Your password doesn't meet all the criteria",
  ...
  premium: {
    ...
    priceAmount: "€10",
    pricePeriod: "/ month",
    noCommitment: "No commitment — cancel in one click.",
    securePayment: "Secure payment via Stripe.",
    transparencyTitle: "Where your money goes",
    transparencyHint:
      "No investors, no ads: your subscription covers the real cost of the service.",
    costAI: "AI and translation",
    costInfra: "Servers",
    costFees: "Payment fees",
    costDev: "Development",
    accountTitle: "Subscription",
    priceMonthly: "€10 / month",
    statusFreeTitle: "Free plan",
    statusFreeHint:
      "Unlimited translations; 10 partners and 50 AI tutor messages per day.",
    statusPremiumTitle: "Premium ✨",
    statusPremiumHint: ({ date }) => `Active until ${date}.`,
    manageCta: "Manage subscription",
    planPremium: "Premium",
    featurePartners: "Partners",
    featureScenarios: "Roleplay scenarios",
    featureHearts: "Lesson hearts",
    allScenarios: "All",
    perDay: ({ n }) => `${n} / day`,
    featureBot: "AI tutor",
    unlimited: "Unlimited",
