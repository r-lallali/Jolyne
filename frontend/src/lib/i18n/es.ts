...
export const es: Messages = {
  ...
  premium: {
    ...
    perksTitle: "Con Premium, sin ningún límite:",
    perkSwipe: "Conoce a tantos compañeros como quieras",
    perkTranslate: "Traducciones ilimitadas",
    perkBot: "Habla sin fin con el profe IA",
